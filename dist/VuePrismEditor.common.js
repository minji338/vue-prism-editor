...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"1f207ce1-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Editor.vue?vue&type=template&id=88387814&
var render = function () {
var _obj;
...
// CONCATENATED MODULE: ./src/components/Editor.vue?vue&type=template&id=88387814&
...
function position(el, pos) {
  ...
  if (1 == arguments.length) {
    ...
    indexes.end = isIE11 ? clone.toString().replace(/\r\n/g, "\n").length : clone.toString().length;
    clone.setStart(range.startContainer, range.startOffset);
    indexes.start = indexes.end - (isIE11 ? clone.toString().replace(/\r\n/g, "\n").length : clone.toString().length);
...
/* harmony default export */ var Editorvue_type_script_lang_js_ = ({
  ...
  mounted: function mounted() {
    ...
    var onPaste = function onPaste(e) {
      ...
      if (_this3.isIE11) {
        ...
        _this3.insertHTML(text);
      } else {
        _this3.insertHTML(escape_html_default()(text));
      }
  ...
  methods: {
    ...
    handleKeyDown: function handleKeyDown(evt) {
      ...
      if (evt.keyCode === 9 && !this.ignoreTabKey) {
        ...
        if (!this.isIE11) {
          ...
          var r = selection_range(this.$refs.pre);
          r.start = r.end + dummy;
          selection_range(this.$refs.pre, r);
        }
    ...
    insertHTML: function insertHTML(text) {
      if (this.isIE11) {
